...
public class ServerScreen extends JPanel implements MouseListener, ActionListener, KeyListener {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (game.checkWinner().equals("player1")) {
            ...
            g.drawImage(harold, Integer.parseInt(game.getPlayer2Coordinate().split(" ")[0]), Integer.parseInt(game.getPlayer2Coordinate().split(" ")[1]), null);
        }
    } 
    ...
    public void checkCollision() {
        ...
        if (gameItems.containsKey(coordinate)) {
            ...
            if (itemName != null && !itemName.contains("fire") && !itemName.equals("bomb")) {
                ...
                game.addToCollectedItems1(itemName);
                // playGetItemSound();

                if (game.getCollectedItems1().size() > 5) {
    ...
    public void keyPressed(KeyEvent e) {
        ...
        checkCollision();
        game.setPlayer1Coordinate(playerX + " " + playerY);
